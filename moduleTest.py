...
#    parser.add_argument('--verbose', type=int, nargs='?', const=10000, default=-1, help='Verbose settings.')
    ...
    parser.add_argument('--onlyReadModule', type=bool, nargs='?', const=True, help='Skip test and read module ID.')
...
#        xmlConfig = readXmlConfig(xmlPyConfigFile)
        ...
        xmlConfig = makeXmlPyConfig(board, slots, hybrids, strips, pixels, lpGBTfile, edgeSelect, outFile, Nevents=50)
