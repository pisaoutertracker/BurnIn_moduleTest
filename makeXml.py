...
def makeXmlPyConfig(board, opticalGroups, hybrids, strips, pixels, lpGBTfile='default', edgeSelect='default', outFile="PS_Module_settings_autogenerated.py", lpGBT_versions=[], Nevents=50):
    config = { 
        "Nevents" : Nevents,
        "boards" : {
            0 : {
    ...
    if lpGBTfile=='default': ## takes default value from Ph2ACF
    ...
    for i, o in enumerate(opticalGroups):
        ...
        config["boards"][0]["opticalGroups"][o]["lpGBT"] = lpGBT_versions[i]
        #lpGBT_versions
