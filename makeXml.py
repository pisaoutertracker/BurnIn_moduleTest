...
def makeXmlPyConfig(board, opticalGroups, hybrids, strips, pixels, lpGBTfile, edgeSelect='None', outFile="PS_Module_settings_autogenerated.py", Nevents=50):
    config = { 
        "Nevents" : Nevents,
        "boards" : {
            0 : {
    ...
    if edgeSelect=='None': ## hardcoded to reproduce https://gitlab.cern.ch/cms_tk_ph2/Ph2_ACF/-/blob/Dev/settings/PS_Module_v2p1.xml?ref_type=heads (edgeSelect=0 for hybrid 1, edgeSelect=1 for hybrid 0) 
