            ...
            for voltage in self.voltage_steps:
                ...
                try:
                    ...
                    measurement = {
                        ...
                        'Current': -parsed_data[f'caen_{self.channel}_Current'] * 1e3, # Convert to nA, set negative for IV curve
    ...
    def save_to_csv(self, output_path, run_info):
        ...
        with open(target_file, 'w') as f:
            ...
            if self.measurements: # avoid division by zero
                ...
                mean_temp = -999
                mean_rh = -999
            f.write(f"{run_info.get('Station_Name', 'TEST_STATION')},{mean_temp:.3f},{mean_rh:.3f}\n\n")
